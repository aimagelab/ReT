...
from third_party.colbert.utils.utils import print_message, zipstar
from third_party.colbert.modeling.tokenization import QueryTokenizer, DocTokenizer, tensorize_triples
from third_party.colbert.evaluation.loaders import load_collection

from third_party.colbert.data.collection import Collection
from third_party.colbert.data.queries import Queries
from third_party.colbert.data.examples import Examples

# from third_party.colbert.utils.runs import Run
