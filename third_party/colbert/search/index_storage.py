...
from third_party.colbert.indexing.loaders import load_doclens
from third_party.colbert.indexing.codecs.residual_embeddings_strided import ResidualEmbeddingsStrided

from third_party.colbert.search.strided_tensor import StridedTensor
from third_party.colbert.search.candidate_generation import CandidateGeneration

from .index_loader import IndexLoader
from third_party.colbert.modeling.colbert import colbert_score, colbert_score_packed, colbert_score_reduce
...
class IndexScorer(IndexLoader, CandidateGeneration):
    ...
    def retrieve(self, config, Q):
        # TODO: we use the full query length
