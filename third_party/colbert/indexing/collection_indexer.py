...
from third_party.colbert.infra.config.config import ColBERTConfig

import third_party.colbert.utils.distributed as distributed
...
from third_party.colbert.data.collection import Collection
...
from third_party.colbert.utils.utils import flatten, print_message
...
class CollectionIndexer():
    ...
    def __init__(self, config: ColBERTConfig, collection, verbose=2):
        ...
        self.checkpoint = RetrieverModel.from_pretrained(self.config.checkpoint_path).get_passage_model()
